...
public final class SignInViewModel extends androidx.lifecycle.ViewModel {
    ...
    private final androidx.compose.runtime.MutableState signInDataState$delegate = null;
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.massage.massenger.presentation.messaging.sign_in.SignInDataState getSignInDataState() {
        return null;
    }
    
    private final void setSignInDataState(com.massage.massenger.presentation.messaging.sign_in.SignInDataState p0) {
    }
    ...
    com.massage.massenger.presentation.messaging.sign_in.SignInFormEvent event) {
    }
    
    private final void signIn(com.massage.massenger.presentation.messaging.sign_in.SignInData signInData) {
    }
