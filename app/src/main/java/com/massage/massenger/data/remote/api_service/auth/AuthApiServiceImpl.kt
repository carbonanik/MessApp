...
class AuthApiServiceImpl(
    ...
    override suspend fun signUp(authRequest: AuthRequest) = withContext(Dispatchers.IO) {
    ...
    override suspend fun login(authRequest: AuthRequest) = withContext(Dispatchers.IO) {
        client.post<AuthResponse> {
